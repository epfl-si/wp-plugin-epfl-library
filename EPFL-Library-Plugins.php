	...
	if (( $hide_beastbox == "") && (!(is_admin()))) {
		...
		if (function_exists('pll_current_language')) {
			if ( pll_current_language() == 'fr' ) {
				$content .= do_shortcode( "[remote_content url='https://sisbdev.epfl.ch/beast/searchbox']" ) ;

			}
			else {
				$content .= do_shortcode( "[remote_content url='https://sisbdev.epfl.ch/beast/searchbox?lang=en']" );
			}
		}
		// Default French
		else {
